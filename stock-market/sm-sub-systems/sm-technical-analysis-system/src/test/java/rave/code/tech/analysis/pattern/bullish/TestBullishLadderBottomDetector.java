...
public class TestBullishLadderBottomDetector {

    @Test
    public void testLadderBottomDetector(){
        ...
        boolean result = BullishLadderBottomDetector.isLadderBottom(c1, c2, c3, c4, c5);
