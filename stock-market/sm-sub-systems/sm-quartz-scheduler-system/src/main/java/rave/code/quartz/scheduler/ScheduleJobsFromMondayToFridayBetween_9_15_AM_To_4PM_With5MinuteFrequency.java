...
public class ScheduleJobsFromMondayToFridayBetween_9_15_AM_To_4PM_With5MinuteFrequency extends AbstractQuartzScheduler{
    ...
    public void scheduleJobs() {
        new ScheduleJobsFromMondayToFridayBetween_9_15_AM_To_10_AM_With5MinuteFrequency(this.scheduler).scheduleJobs();
        new ScheduleJobsFromMondayToFridayBetween_10_AM_To_4_PM_With5MinuteFrequency(this.scheduler).scheduleJobs();
    }
    ...
    private class ScheduleJobsFromMondayToFridayBetween_9_15_AM_To_10_AM_With5MinuteFrequency extends AbstractQuartzScheduler {
        ...
        public void scheduleJobs() {
            ...
            JobDetail bseActive100JobDetail = newJob(BSEActive100Job.class)
                    .withIdentity(QuartzJob.BSE_ACTIVE_100_JOB_NAME.getName(), QuartzGroup.TRADING_BATCH_1.toString()).storeDurably()
                    .build();
            JobDetail bseActive200JobDetail = newJob(BSEActive200Job.class)
                    .withIdentity(QuartzJob.BSE_ACTIVE_200_JOB_NAME.getName(), QuartzGroup.TRADING_BATCH_1.toString()).storeDurably()
                    .build();
            JobDetail bseActive500JobDetail = newJob(BSEActive500Job.class)
                    .withIdentity(QuartzJob.BSE_ACTIVE_500_JOB_NAME.getName(), QuartzGroup.TRADING_BATCH_1.toString()).storeDurably()
                    .build();
            JobDetail bsePriceShockersJobDetail = newJob(BSEPriceShockersJob.class)
                    .withIdentity(QuartzJob.BSE_PRICE_SHOCKERS_JOB_NAME.getName(), QuartzGroup.TRADING_BATCH_1.toString()).storeDurably()
                    .build();
            JobDetail bseVolumeShockersJobDetail = newJob(BSEVolumeShockersJob.class)
                    .withIdentity(QuartzJob.BSE_VOLUME_SHOCKERS_JOB_NAME.getName(), QuartzGroup.TRADING_BATCH_1.toString()).storeDurably()
                    .build();
            JobDetail bseTopDividendJob = newJob(BSETopDividendJob.class)
                    .withIdentity(QuartzJob.BSE_TOP_DIVIDEND_JOB_NAME.getName(), QuartzGroup.INVESTING_BATCH_1.toString()).storeDurably()
                    .build();
            JobDetail bseMidCapGainerJob = newJob(BSEMidCapGainerJob.class)
                    .withIdentity(QuartzJob.BSE_MID_CAP_GAINER_JOB_NAME.getName(), QuartzGroup.INVESTING_BATCH_1.toString()).storeDurably()
                    .build();
            JobDetail bseSmallCapGainerJob = newJob(BSESmallCapGainerJob.class)
                    .withIdentity(QuartzJob.BSE_SMALL_CAP_GAINER_JOB_NAME.getName(), QuartzGroup.INVESTING_BATCH_1.toString()).storeDurably()
                    .build();
            JobDetail sensexJobDetail = newJob(BSESensexJob.class)
                    .withIdentity(QuartzJob.BSE_SENSEX_JOB_NAME.getName(), QuartzGroup.MISCELLANEOUS_BATCH_1.toString())
                    .build();


            org.quartz.Trigger bseActive100JobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_ACTIVE_100_TRIGGER_NAME.get(), QuartzGroup.TRADING_BATCH_1.toString())
            ...
            org.quartz.Trigger bseActive200JobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_ACTIVE_200_TRIGGER_NAME.get(), QuartzGroup.TRADING_BATCH_1.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_9_15AM_TO_10AM.toString()))
            ...
            org.quartz.Trigger bseActive500JobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_ACTIVE_500_TRIGGER_NAME.get(), QuartzGroup.TRADING_BATCH_1.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_9_15AM_TO_10AM.toString()))
            ...
            org.quartz.Trigger bsePriceShockersJobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_PRICE_SHOCKERS_TRIGGER_NAME.get(), QuartzGroup.TRADING_BATCH_1.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_9_15AM_TO_10AM.toString()))
            ...
            org.quartz.Trigger bseVolumeShockersJobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_VOLUME_SHOCKERS_TRIGGER_NAME.get(), QuartzGroup.TRADING_BATCH_1.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_9_15AM_TO_10AM.toString()))
            ...
            org.quartz.Trigger bseTopDividendJobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_TOP_DIVIDEND_TRIGGER_NAME.get(), QuartzGroup.INVESTING_BATCH_1.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_9_15AM_TO_10AM.toString()))
            ...
            org.quartz.Trigger bseMidCapGainerJobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_MID_CAP_GAINER_TRIGGER_NAME.get(), QuartzGroup.INVESTING_BATCH_1.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_9_15AM_TO_10AM.toString()))
            ...
            org.quartz.Trigger bseSmallCapGainerJobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_SMALL_CAP_GAINER_TRIGGER_NAME.get(), QuartzGroup.INVESTING_BATCH_1.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_9_15AM_TO_10AM.toString()))
            ...
            org.quartz.Trigger sensexJobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_SENSEX_TRIGGER_NAME.get(), QuartzGroup.MISCELLANEOUS_BATCH_1.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_9_15AM_TO_10AM.toString()))
    ...
    private class ScheduleJobsFromMondayToFridayBetween_10_AM_To_4_PM_With5MinuteFrequency extends AbstractQuartzScheduler {
        ...
        public void scheduleJobs() {
            ...
            JobDetail bseActive100JobDetail = newJob(BSEActive100Job.class)
                    .withIdentity(QuartzJob.BSE_ACTIVE_100_JOB_NAME.getName(), QuartzGroup.TRADING_BATCH_2.toString()).storeDurably()
                    .build();
            JobDetail bseActive200JobDetail = newJob(BSEActive200Job.class)
                    .withIdentity(QuartzJob.BSE_ACTIVE_200_JOB_NAME.getName(), QuartzGroup.TRADING_BATCH_2.toString()).storeDurably()
                    .build();
            JobDetail bseActive500JobDetail = newJob(BSEActive500Job.class)
                    .withIdentity(QuartzJob.BSE_ACTIVE_500_JOB_NAME.getName(), QuartzGroup.TRADING_BATCH_2.toString()).storeDurably()
                    .build();
            JobDetail bsePriceShockersJobDetail = newJob(BSEPriceShockersJob.class)
                    .withIdentity(QuartzJob.BSE_PRICE_SHOCKERS_JOB_NAME.getName(), QuartzGroup.TRADING_BATCH_2.toString()).storeDurably()
                    .build();
            JobDetail bseVolumeShockersJobDetail = newJob(BSEVolumeShockersJob.class)
                    .withIdentity(QuartzJob.BSE_VOLUME_SHOCKERS_JOB_NAME.getName(), QuartzGroup.TRADING_BATCH_2.toString()).storeDurably()
                    .build();
            JobDetail bseTopDividendJob = newJob(BSETopDividendJob.class)
                    .withIdentity(QuartzJob.BSE_TOP_DIVIDEND_JOB_NAME.getName(), QuartzGroup.INVESTING_BATCH_2.toString()).storeDurably()
                    .build();
            JobDetail bseMidCapGainerJob = newJob(BSEMidCapGainerJob.class)
                    .withIdentity(QuartzJob.BSE_MID_CAP_GAINER_JOB_NAME.getName(), QuartzGroup.INVESTING_BATCH_2.toString()).storeDurably()
                    .build();
            JobDetail bseSmallCapGainerJob = newJob(BSESmallCapGainerJob.class)
                    .withIdentity(QuartzJob.BSE_SMALL_CAP_GAINER_JOB_NAME.getName(), QuartzGroup.INVESTING_BATCH_2.toString()).storeDurably()
                    .build();
            JobDetail sensexJobDetail = newJob(BSESensexJob.class)
                    .withIdentity(QuartzJob.BSE_SENSEX_JOB_NAME.getName(), QuartzGroup.MISCELLANEOUS_BATCH_2.toString())
                    .build();


            org.quartz.Trigger bseActive100JobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_ACTIVE_100_TRIGGER_NAME.get(), QuartzGroup.TRADING_BATCH_2.toString())
                    ...
                    .build();
            org.quartz.Trigger bseActive200JobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_ACTIVE_200_TRIGGER_NAME.get(), QuartzGroup.TRADING_BATCH_2.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_10AM_TO_4PM.toString()))
                    .withPriority(Priorities.MID.get()).withDescription(TriggerDescription.BSE_ACTIVE_200.get())
                    .build();
            org.quartz.Trigger bseActive500JobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_ACTIVE_500_TRIGGER_NAME.get(), QuartzGroup.TRADING_BATCH_2.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_10AM_TO_4PM.toString()))
                    .withPriority(Priorities.MID.get()).withDescription(TriggerDescription.BSE_ACTIVE_500.get())
                    .build();
            org.quartz.Trigger bsePriceShockersJobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_PRICE_SHOCKERS_TRIGGER_NAME.get(), QuartzGroup.TRADING_BATCH_2.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_10AM_TO_4PM.toString()))
                    .withPriority(Priorities.MID.get()).withDescription(TriggerDescription.BSE_PRICE_SHOCKER.get())
                    .build();
            org.quartz.Trigger bseVolumeShockersJobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_VOLUME_SHOCKERS_TRIGGER_NAME.get(), QuartzGroup.TRADING_BATCH_2.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_10AM_TO_4PM.toString()))
                    .withPriority(Priorities.MID.get()).withDescription(TriggerDescription.BSE_VOLUME_SHOCKER.get())
                    .build();
            org.quartz.Trigger bseTopDividendJobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_TOP_DIVIDEND_TRIGGER_NAME.get(), QuartzGroup.INVESTING_BATCH_2.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_10AM_TO_4PM.toString()))
                    .withPriority(Priorities.MID.get()).withDescription(TriggerDescription.BSE_TOP_DIVIDEND.get())
                    .build();
            org.quartz.Trigger bseMidCapGainerJobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_MID_CAP_GAINER_TRIGGER_NAME.get(), QuartzGroup.INVESTING_BATCH_2.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_10AM_TO_4PM.toString()))
                    .withPriority(Priorities.MID.get()).withDescription(TriggerDescription.BSE_MID_CAP_GAINER.get())
                    .build();
            org.quartz.Trigger bseSmallCapGainerJobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_SMALL_CAP_GAINER_TRIGGER_NAME.get(), QuartzGroup.INVESTING_BATCH_2.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_10AM_TO_4PM.toString()))
                    .withPriority(Priorities.MID.get()).withDescription(TriggerDescription.BSE_SMALL_CAP_GAINER.get())
                    .build();
            org.quartz.Trigger sensexJobTrigger = newTrigger()
                    .withIdentity(QuartzTrigger.BSE_SENSEX_TRIGGER_NAME.get(), QuartzGroup.MISCELLANEOUS_BATCH_2.toString())
                    .withSchedule(CronScheduleBuilder.cronSchedule(CronExpression.EVERY_3RD_MINUTE_OF_THE_CLOCK_FROM_MONDAY_TO_FRIDAY_BETWEEN_10AM_TO_4PM.toString()))
                    .withPriority(Priorities.MID.get()).withDescription(TriggerDescription.SENSEX.get())
                    .build();
