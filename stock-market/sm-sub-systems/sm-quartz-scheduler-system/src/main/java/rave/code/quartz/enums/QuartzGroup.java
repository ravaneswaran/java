...
public enum QuartzGroup {
    ...
    NSE_PRE_OPEN_MARKET_HISTORY("NSE Pre Open Market History", "GROUP-PRE-OPEN-MARKET-HISTORY"),
    NSE_LIVE_SESSION("NSE Live Session", "GROUP-LIVE-SESSION"),
    NSE_DAILY_TRADE_DETAILS_MAILER("NSE Daily Trade Details Mailer", "GROUP-MAILER"),
