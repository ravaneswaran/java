...
import rave.code.data.model.web.nse.page.top20.Top20SecuritiesGTR20WebPage;
...
@Service
public class NSETop20SecuritiesGtr20Service extends AbstractNSETop20Service<NSETop20SecurityGTR20Model, Top20SecuritiesGTR20WebPage> {

    private NSETop20DetailRepository nseTop20DetailRepository = new NSETop20DetailRepository();

    @Override
    public Top20SecuritiesGTR20WebPage getWebPage() {
        List<NSETop20DetailEntity> entities = this.getEntities();
        Top20SecuritiesGTR20WebPage top20SecuritiesGTR20Page = new Top20SecuritiesGTR20WebPage();
        top20SecuritiesGTR20Page.setNseTop20SecurityGTR20Models(this.transformEntities(entities));
        top20SecuritiesGTR20Page.setNseStockModels(this.getNSEStockModels(entities));
        return top20SecuritiesGTR20Page;
    }

    @Override
    public List<NSETop20DetailEntity> getEntities() {
        return this.nseTop20DetailRepository.findTop20SecurityGTR20();
    }
