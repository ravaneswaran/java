...
public class TestQuartzFiredTrigger extends TestCase {
    ...
    public static QuartzFiredTriggerEntity newQuartzFiredTriggerEntityInstance(){
        ...
        quartzEntryId.setEntryId("TEST_ENTRY_ID_"+ StockMarketDate.getInstance().now().getTime());
        ...
        quartzFiredTriggerEntity.setFiredTime(StockMarketDate.getInstance().now().getTime());
        quartzFiredTriggerEntity.setScheduledTime(StockMarketDate.getInstance().now().getTime());
