...
public class ConcealingBabySwallowDetector {

    private static final double SHADOW_TOLERANCE = 0.05;

    private static boolean isBearishMarubozu(Candle c) {
    ...
    public static boolean isConcealingBabySwallow(Candle c1, Candle c2, Candle c3, Candle c4) {
        ...
        boolean firstMarubozu = isBearishMarubozu(c1);
        boolean secondMarubozu = isBearishMarubozu(c2);
