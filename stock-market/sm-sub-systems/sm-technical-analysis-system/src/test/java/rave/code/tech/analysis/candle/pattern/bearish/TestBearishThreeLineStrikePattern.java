...
public class TestBearishThreeLineStrikePattern {
    ...
    public void testBearishThreeLineStrikePattern(){
        Candle c1 = new Candle(120, 122, 114, 115,0);
        Candle c2 = new Candle(114, 116, 108, 109,0);
        Candle c3 = new Candle(108, 110, 102, 103,0);
        Candle c4 = new Candle(101, 126, 100, 124,0);
