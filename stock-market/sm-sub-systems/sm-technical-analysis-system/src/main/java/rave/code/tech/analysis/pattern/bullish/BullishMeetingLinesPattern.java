...
public class BullishMeetingLinesPattern extends AbstractPattern {
    ...
    public static boolean isMeetingLines(Candle c1, Candle c2) {
        ...
        // Optional gap down
        boolean gapDown = c2.getOpenPrice() < c1.getClosePrice();

        // Closes approximately equal
        double tolerance = c1.getClosePrice() * TOLERANCE_PERCENT;

        boolean sameClose = Math.abs(c1.getClosePrice() - c2.getClosePrice()) <= tolerance;
