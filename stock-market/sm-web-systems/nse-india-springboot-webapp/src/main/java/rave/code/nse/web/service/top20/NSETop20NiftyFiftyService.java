...
import rave.code.data.model.web.nse.page.top20.Top20NiftyFiftyWebPage;
...
@Service
public class NSETop20NiftyFiftyService extends AbstractNSETop20Service<NSETop20NiftyFiftyModel, Top20NiftyFiftyWebPage> {

    private NSETop20DetailRepository nseTop20DetailRepository = new NSETop20DetailRepository();

    @Override
    public Top20NiftyFiftyWebPage getWebPage() {
        List<NSETop20DetailEntity> entities = this.getEntities();
        Top20NiftyFiftyWebPage top20NiftyFiftyPage = new Top20NiftyFiftyWebPage();
        top20NiftyFiftyPage.setNseTop20NiftyFiftyModels(this.transformEntities(entities));
        top20NiftyFiftyPage.setNseStockModels(this.getNSEStockModels(entities));
    ...
    public List<NSETop20NiftyFiftyModel> transformEntities(List<NSETop20DetailEntity> nseTop20DetailEntities) {
        ...
        for (NSETop20DetailEntity nseTop20DetailEntity: nseTop20DetailEntities){
            ...
            if (null != series && !"".equals(series) && !"null".equals(series)) {
                nseTop20NiftyFiftyModel.setTitle(String.format("%s:%s", series, nseTop20DetailEntity.getSymbol()));
            } else {
                nseTop20NiftyFiftyModel.setTitle(nseTop20DetailEntity.getSymbol());
            }
