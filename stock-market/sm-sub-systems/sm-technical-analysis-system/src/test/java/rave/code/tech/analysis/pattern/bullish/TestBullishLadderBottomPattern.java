...
public class TestBullishLadderBottomPattern {
    ...
    public void testLadderBottomPattern() {
        Candle c1 = new Candle(100, 95, 101, 94, 0, 0);
        Candle c2 = new Candle(95, 90, 96, 89, 0, 0);
        Candle c3 = new Candle(90, 85, 91, 84, 0, 0);
        Candle c4 = new Candle(85, 82, 89, 81, 0, 0);
        Candle c5 = new Candle(83, 92, 93, 82, 0, 0);
