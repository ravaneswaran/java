...
public class NSESpecialPreOpenMarketScheduler extends AbstractQuartzScheduler {

    public static final Logger LOGGER = Logger.getLogger(NSESpecialPreOpenMarketScheduler.class.toString());

    private Scheduler scheduler;

    public NSESpecialPreOpenMarketScheduler(Scheduler scheduler) {
    ...
    public void scheduleJob(){} {
        ...
        JobDetail nsePreOpenMarketNifty50EntityMakerJob = newJob(NSEPreOpenMarketNifty50EntityMakerJob.class)
                .withIdentity(Job.NSE_PRE_OPEN_SPECIAL_SESSION.getName(), Group.PRE_OPEN_SPECIAL_SESSION.name())
                .build();
        ...
        Trigger preOpenMarketRegularSessionTrigger = newTrigger()
                .withIdentity(TriggerName.NSE_PRE_MARKET_SPECIAL_SESSION_TRIGGER.get(), Group.PRE_OPEN_SPECIAL_SESSION.toString())
