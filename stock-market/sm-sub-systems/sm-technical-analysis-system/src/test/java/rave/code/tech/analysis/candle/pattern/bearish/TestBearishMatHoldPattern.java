...
public class TestBearishMatHoldPattern {
    ...
    public void testBearishMatHoldPattern(){
        Candle c1 = new Candle(120,121,100,102,0);
        Candle c2 = new Candle(103,106,102,105,0);
        Candle c3 = new Candle(105,108,104,107,0);
        Candle c4 = new Candle(107,109,105,106,0);
        Candle c5 = new Candle(105,106,90,95,0);
