...
public class TestBullishRisingThreeMethodsPattern {
    ...
    public void testBullishRisingThreeMethodsPattern(){
        Candle c1 = new Candle(100, 110, 112, 99,0);
        Candle c2 = new Candle(109, 107, 110, 105,0);
        Candle c3 = new Candle(108, 106, 109, 104,0);
        Candle c4 = new Candle(107, 105, 108, 103,0);
        Candle c5 = new Candle(106, 115, 116, 105,0);
