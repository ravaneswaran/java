...
public class BearishHaramiDetector extends AbstractPatternDetector {

    public BearishHaramiDetector() {
        super(2);
    }
    ...
    public boolean detect(List<Candle> candles) {
        if (null != candles && candles.size() >= this.minimumCandles) {
            return BearishHaramiDetector.isHarami(candles.get(0), candles.get(1));
        } else {
            return false;
        }
    }
